...
// The CEFR 22-point human evaluator set: 22 micro-levels x 6 skills x 2 questions.
// Regenerate by re-running the parse if the source workbook changes.
...
export const CEFR_LEVELS: CefrLevelSeed[] = [
  {
    "code": "A0",
    "label": "A0",
    "order": 1
